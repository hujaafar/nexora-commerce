...
export class AdminService {
  ...
  deleteProduct(id: string): Observable<void> {
    return this.http.delete<void>(`${environment.apiUrl}/products/moderation/${id}`);
  }

  listMedia(): Observable<MediaAsset[]> {
    return this.http.get<MediaAsset[]>(`${environment.apiUrl}/media/images/moderation`);
  }

  deleteMedia(id: string): Observable<void> {
    return this.http.delete<void>(`${environment.apiUrl}/media/images/moderation/${id}`);
  }
}
