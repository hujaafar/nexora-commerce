...
param(
    [string]$MongoContainer = 'nexora-mongo-1',
    [string]$MinioContainer = 'nexora-minio-1',
    [string]$ProductDatabase = 'nexora_products',
    [string]$MediaDatabase = 'nexora_media',
    [string]$MediaBucket = 'nexora-media'
)
