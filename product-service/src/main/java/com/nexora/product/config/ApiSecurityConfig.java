 ...
 */
package com.nexora.product.config;
    ...
    SecurityFilterChain securityFilterChain(
        ...
        return http
                ...
                .authorizeHttpRequests(requests -> requests
                        ...
                        // The controller still verifies a constant-time shared token.
                        .requestMatchers(HttpMethod.POST, "/internal/products/**").permitAll()
